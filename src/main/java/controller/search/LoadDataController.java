...
public class LoadDataController implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        if ("GET".equals(exchange.getRequestMethod())) {
            ...
            if (userId != null) {
                // Fetch the saved search terms based on the user's ID
                JsonArray searchTermsArray = fetchUserSearchTerms(userId);
